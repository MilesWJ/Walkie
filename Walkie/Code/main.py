...
def check_all_messages(message):
    ...
    response(responses.question_adjective(), ["do", "you",
             "like", "to", "listen"], required_words=["you", "indulge"])

    response(responses.status(), ["what", "do",
             "you", "think"], required_words=["you", "think"])
    ...
    response(responses.gender(), ["what", "is", "your", "gender"],
             required_words=["your", "gender"])

    response(responses.gender(), ["are", "you", "a", "girl", "or", "a", "boy"],
             required_words=["you", "girl", "boy"])

    response(responses.gender(), ["are", "you", "male", "or", "female"],
             required_words=["you", "male", "female"])
